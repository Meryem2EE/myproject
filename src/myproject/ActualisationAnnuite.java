...
import javax.swing.*;
 ...
 public class ActualisationAnnuite extends JFrame implements ActionListener {
	...
	public ActualisationAnnuite() {
		super();
		setTitle("Calcul du Facteur D'Actualisation d'Annuite (P/A,i,N)");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==aprpos)
                ...
                if(e.getSource()==calculer)
                {
                    ...
                    double dd=A*(((Math.pow(iResult+1,N))-1)/((Math.pow(iResult+1,N))*iResult)); 
                    JOptionPane.showMessageDialog(this,"P = "+dd+" $","Resultat",JOptionPane.INFORMATION_MESSAGE);
                }
             }
	...
	public static void main(String[] args) {
		ActualisationAnnuite  f = new ActualisationAnnuite ();
		f.setVisible(true);
           //     f.pack();
	}
}
