...
//import myproject.Acceuil;
 ...
 public class Annuite extends JFrame implements ActionListener {
	...
	public Annuite() {
		super();
		setTitle("Calcul d'Annuité (A/F,i,N)");
		...
		panel1.add(info);
                ...
                p1.add(new JLabel("Montant à accumulé F :"));p1.add(f);
	...
	public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==hlp)
		{
			JOptionPane.showMessageDialog(this,"calcul d'Anuité A  \n à partir des données saisis.",
		...
		if(e.getSource()==aprpos)
                { JOptionPane.showMessageDialog(this,"copyright 2014 ,Elouragini Meryem \n","",JOptionPane.INFORMATION_MESSAGE);}
                    ...
                    double dd=F/(((Math.pow(iResult+1,N))-1)/iResult); 
         ...
         double calculI(double ii){
            double resultI=0.0;
                       if (combo3.getSelectedItem().equals("semestriellement") && combo2.getSelectedItem().equals("trimestriel")){
                            ...
                            ii=ii+1;
                           resultI=(double)Math.pow(ii,0.0833)-1;
                        }else {
                            resultI=ii;
                        }
                    return resultI;
