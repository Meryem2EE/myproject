...
public class Demineur extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==hlp)
		{
			JOptionPane.showMessageDialog(this,"calcul du montant initial P\n à partir des données saisis.",
		...
		if(e.getSource()==aprpos)
                ...
                if(e.getSource()==calculer)
                {
                  ...
                  double aa=P*1/Math.pow(I+1,N);  
                    JOptionPane.showMessageDialog(this,"P = "+aa+" $","",JOptionPane.INFORMATION_MESSAGE);
                }
                }
	}
