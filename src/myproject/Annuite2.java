...
//import myproject.Acceuil;
 ...
 public class Annuite2 extends JFrame implements ActionListener {
	...
	public Annuite2() {
		super();
		setTitle("Calcul d'Annuité (A/P,i,N)");
		...
		panel1.add(info);
                ...
                p1.add(new JLabel("Montant initial P :"));p1.add(p);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==aprpos)
                { JOptionPane.showMessageDialog(this,"copyright 2014 ,Elouragini Meryem \n","",JOptionPane.INFORMATION_MESSAGE);}
                    ...
                    double dd=P/(((Math.pow(iResult+1,N))-1)/((Math.pow(iResult+1,N))*iResult));
